...
export function RecordVitalsForm({ patient, onSuccess }: RecordVitalsFormProps) {
    ...
    const onSubmit = async (values: z.infer<typeof NursingVitalsSchema>) => {
        /**
         * == WORKFLOW: LOG VITALS ==
         * This function calls the `addVitals` server action which would, in a real app,
         * invoke the corresponding secure Cloud Function `logVitals`.
         */
