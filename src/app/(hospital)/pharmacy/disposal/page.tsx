    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 text-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-4">
           ...
           <div className="bg-card rounded-[32px] border shadow-sm h-[560px] overflow-y-auto divide-y bg-white dark:bg-slate-900 dark:border-slate-800">
              {isInventoryLoading ? (
                   ...
                   <div className="space-y-4">
                     ...
                     <div>
                       ...
                       <select 
                         ...
                         className="w-full p-3.5 border rounded-2xl bg-slate-50 dark:bg-slate-950 text-foreground font-bold text-xs outline-none"
                       >
