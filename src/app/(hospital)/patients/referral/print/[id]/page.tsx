...
import { Printer, ArrowLeft, Landmark, FileText, Stethoscope } from 'lucide-react';
...
export default function ReferralPrintPage() {
  ...
  if (isLoading) {
    return <div className="p-20 text-center"><Skeleton className="w-full h-96" /></div>;
  }
    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8 text-black bg-white">
      ...
      <div className="border-[10px] border-double border-slate-900 p-12 font-serif">
        ...
        <section className="space-y-8">
            ...
            <ReferralSection title="Latest Vitals">
                <div className="grid grid-cols-3 gap-2">
                    <p><strong>BP:</strong> {referral.vitalsAtReferral?.bp}</p>
                    <p><strong>Pulse:</strong> {referral.vitalsAtReferral?.pulse} bpm</p>
                    <p><strong>Temp:</strong> {referral.vitalsAtReferral?.temp} °C</p>
                </div>
            </ReferralSection>
            
            <ReferralSection title="Active Medications">
            ...
            <div className="mt-24 border-t-2 border-slate-900 pt-4 text-sm">
                <p className="font-bold">Dr. {referral.referringDoctor}</p>
