    ...
    <aside className="w-64 h-screen bg-white text-slate-800 flex-col border-r border-slate-200 hidden md:flex">
      <div className="p-6 border-b border-slate-200">
        <div className="flex items-center gap-3 mb-1">
          ...
          <span className="font-bold text-primary text-xl tracking-tight">Supply Chain</span>
        </div>
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-background p-4">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">You do not have clearance for Supply Chain.</p>
